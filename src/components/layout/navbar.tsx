...
export function Navbar() {
	return (
		<header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 h-full flex-1 flex-col space-y-8 px-6 md:flex">
			<div className="flex h-14 items-center justify-between">
				<Mobilebar className="block lg:hidden xl:hidden" />
				<div className="mr-4 hidden lg:flex">
					<a className="mr-6 flex items-start space-x-2" href="/">
								...
								<DropdownMenuTrigger asChild>
									<Button variant="ghost" className="relative h-8 w-8 rounded-full">
										<Avatar className="h-7 w-7">
											<AvatarImage src="https://ui.shadcn.com/avatars/03.png" alt="Agus Suandi" />
								...
								<DropdownMenuContent className="w-56" align="end" forceMount>
									<DropdownMenuLabel className="font-normal">
										<div className="flex flex-col space-y-1">
											<p className="text-sm font-medium leading-none">Agus Suandi</p>
											<p className="text-xs leading-none text-muted-foreground">
												agussuandi48@gmail.com
											</p>
										</div>
									</DropdownMenuLabel>
									<DropdownMenuSeparator />
